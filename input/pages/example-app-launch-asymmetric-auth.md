...
Generate a client authentication assertion and prepare arguments for POST to token API. You should retrieve the `code_verifier` from the pre-login session generated above (newlines added for clarity):
