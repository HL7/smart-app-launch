...
*Note that the scope syntax has changed since SMARTv1. Details are in section [Scopes for requesting FHIR resources](scopes-and-launch-context.html#scopes-for-requesting-clinical-data).*
