...
flow, this <code>aud</code> value is the same as the launch's <code>iss</code> value.)
    ...
    <tr>
      ...
      <td><span class="label label-info">optional</span></td>
      <td>This parameter is generated by your app and used for PKCE. This is the S256 hashed version of the code_verifier parameter, which will be used in the token request.</td>
    </tr>
    ...
    <tr>
      ...
      <td><span class="label label-info">optional</span></td>
      <td>This parameter is required if using PKCE and indicates the method used for the <code>code_challenge</code> parameter. Fixed value: <code>S256</code>.</td>
    </tr>
